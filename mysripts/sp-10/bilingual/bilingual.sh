...
ST_SAVE_DIR=/home2/chu/fairseq_sign/sign/experiments/sp-10/bilingual/sign2en/${INPUT_TYPE}-${SRC_LANGS}-${TGT_Langs}
DATASET_DIR=/home2/chu/fairseq_sign/sign/dataset/sp-10/256x256
TENSORBOARD_DIR=/home2/chu/fairseq_sign/sign/experiments/tensorboard/bilingual/${INPUT_TYPE}-${SRC_LANGS}-${TGT_Langs}
rm -r $ST_SAVE_DIR
mkdir $ST_SAVE_DIR -p
...
python /home2/chu/fairseq_sign/sign/train.py  $DATASET_DIR \
    --batch-size-valid 8 \
    ...
    --eval-bleu --eval-mt-bleu --eval-bleu-detok space --eval-bleu-remove-bpe sentencepiece \
